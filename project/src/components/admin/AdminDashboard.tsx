...
import { Users, BookOpen, FileText, BarChart3, TrendingUp, UserCheck, GraduationCap, Award } from 'lucide-react';
...
const AdminDashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'System Rating', value: '4.4/5', icon: Award, color: 'text-yellow-600' }
  ];
